...
//
//	mockgen -source=service/store/querier.go -destination=service/store/querier.mock.go -package=store
//
...
func (m *MockQuerier) CreateHealth(ctx context.Context, arg CreateHealthParams) (Health, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) CreateSource(ctx context.Context, arg CreateSourceParams) (Source, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) DeleteSource(ctx context.Context, id string) (Source, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) GetSource(ctx context.Context, id string) (Source, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) ListSource(ctx context.Context, arg ListSourceParams) ([]Source, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) UpdateSource(ctx context.Context, arg UpdateSourceParams) (Source, error) {
	m.ctrl.T.Helper()
